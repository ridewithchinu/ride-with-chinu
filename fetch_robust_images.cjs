...
const destinationsMap = {
  "nainital": "Nainital Uttarakhand lake town",
  "bhimtal": "Bhimtal lake Uttarakhand",
  "sattal": "Sattal lakes Uttarakhand",
  "naukuchiatal": "Naukuchiatal lake Uttarakhand",
  "jim-corbett": "Jim Corbett National Park tiger safari",
  "almora": "Almora Uttarakhand ridge town",
  "binsar": "Binsar wildlife sanctuary Himalayas",
  "jageshwar": "Jageshwar temple complex Uttarakhand",
  "kausani": "Kausani Himalayan views tea gardens",
  "munsiyari": "Munsiyari Panchachuli view",
  ...
  "rishikesh": "Rishikesh Ganges suspension bridge",
  "mussoorie": "Mussoorie viewpoint colonial hill station",
  "dehradun": "Dehradun Uttarakhand city caves",
  "haridwar": "Haridwar Har Ki Pauri Ganga aarti",
...
async function commonsSearch(query, limit = 5) {
  ...
  const res = await fetch(url, { headers: { 'User-Agent': 'RideWithChinuBot/2.0 (ridewithchinu@gmail.com)' } });
...
async function run() {
  ...
  for (const [slug, query] of Object.entries(destinationsMap)) {
