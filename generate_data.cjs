...
let fileContent = 'export interface Destination {\n';
fileContent += '  id: string;\n';
fileContent += '  name: string;\n';
fileContent += '  region: string;\n';
fileContent += '  district: string;\n';
fileContent += '  category: string[];\n';
fileContent += '  specialty: string[];\n';
fileContent += '  altitude: string;\n';
fileContent += '  best_time: string[];\n';
fileContent += '  avoid_time: string[];\n';
fileContent += '  nearest_airport: string;\n';
fileContent += '  nearest_railway: string;\n';
fileContent += '  road_access: string;\n';
fileContent += '  top_attractions: string[];\n';
fileContent += '  activities: string[];\n';
fileContent += '  cuisine: string[];\n';
fileContent += '  stay_types: string[];\n';
fileContent += '  budget_range: string;\n';
fileContent += '  permits_required: string[];\n';
fileContent += '  travel_tips: string[];\n';
fileContent += '  packing_list: string[];\n';
fileContent += '  festivals: string[];\n';
fileContent += '  nearby_places: { name: string; id: string }[];\n';
fileContent += '  image: string;\n';
fileContent += '  description: string;\n';
fileContent += '}\n\n';

fileContent += 'export const destinations: Destination[] = ' + JSON.stringify(destinations, null, 2) + ';\n\n';

fileContent += 'export const categories = [\n';
fileContent += '  "Hill Stations",\n';
fileContent += '  "Spiritual / Pilgrimage",\n';
fileContent += '  "Adventure Destinations",\n';
fileContent += '  "Wildlife / Nature",\n';
fileContent += '  "Lakes and Scenic Retreats",\n';
fileContent += '  "Trekking / High Altitude",\n';
fileContent += '  "Heritage / Culture",\n';
fileContent += '  "Offbeat / Village Tourism"\n';
fileContent += '];\n';
